...
/**
 * create length batch window test case
 *
 */
public class LengthBatchWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new LengthBatchWindowCreator();
    ...
    {
        return Window.createLengthBatchWindow(1);
    }
