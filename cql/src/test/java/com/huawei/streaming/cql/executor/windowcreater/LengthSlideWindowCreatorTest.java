...
/**
 * create length slide window test case
 *
 */
public class LengthSlideWindowCreatorTest
{
    ...
    public void testCreateInstance()
        throws Exception
    {
        WindowCreator creater = new LengthSlideWindowCreator();
    ...
    {
        return Window.createLengthSlideWindow(1);
    }
