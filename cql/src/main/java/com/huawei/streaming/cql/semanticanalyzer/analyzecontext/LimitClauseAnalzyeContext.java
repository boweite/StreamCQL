 ...
 * 
 */
public class LimitClauseAnalzyeContext extends AnalyzeContext
{
    private LimitClauseContext context;
    ...
    {
        context = (LimitClauseContext)parseContext;
    }
    ...
    {
        ConstUtils.formatInt(context.getLimitRows());
    }
    ...
    {
        return Integer.valueOf(context.getLimitRows());
    }
}
