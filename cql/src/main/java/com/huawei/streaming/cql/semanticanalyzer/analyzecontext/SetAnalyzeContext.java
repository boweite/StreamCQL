 ...
 * 
 */
public class SetAnalyzeContext extends AnalyzeContext
{
    private SetStatementContext context;
    ...
    {
        context = (SetStatementContext)parseContext;
    }
    ...
    {
        return CQLUtils.cqlStringLiteralTrim(context.getConfName());
    }
    
    public String getValue()
    {
        return context.getConfValue();
    }
