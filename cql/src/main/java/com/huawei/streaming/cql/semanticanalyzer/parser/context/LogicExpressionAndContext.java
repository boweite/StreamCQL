...
{
    //LogicExpressionNotContext
    private List<BaseExpressionParseContext> expressions = null;
    ...
    private ExpressionDescribe createBinaryExpression()
        throws SemanticAnalyzerException
    {
        BinaryExpression bexp = BinaryExpressionRegistry.getBinaryExpressionByName("and");
