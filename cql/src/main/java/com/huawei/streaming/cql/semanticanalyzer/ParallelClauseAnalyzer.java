 ...
 * 
 */
public class ParallelClauseAnalyzer extends BaseAnalyzer
{
    private ParallelClauseAnalyzeContext submitContext;
     ...
     */
    public ParallelClauseAnalyzer(ParseContext parseContext)
    ...
    {
        submitContext = new ParallelClauseAnalyzeContext();
    }
