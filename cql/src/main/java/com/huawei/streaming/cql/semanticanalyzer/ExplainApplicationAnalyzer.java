 ...
 * 
 */
public class ExplainApplicationAnalyzer extends BaseAnalyzer
{
    private ExplainApplicationAnalyzeContext context = null;
     ...
     */
    public ExplainApplicationAnalyzer(ParseContext parseContext)
    ...
    {
        context = new ExplainApplicationAnalyzeContext();
    }
