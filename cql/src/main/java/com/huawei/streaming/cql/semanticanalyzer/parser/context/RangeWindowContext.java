 ...
 * 
 */
public class RangeWindowContext extends ParseContext
{
    private RangeBoundContext bound;
    ...
    public RangeBoundContext getBound()
    {
        return bound;
    }
    
    public void setBound(RangeBoundContext bound)
    {
        this.bound = bound;
    }
