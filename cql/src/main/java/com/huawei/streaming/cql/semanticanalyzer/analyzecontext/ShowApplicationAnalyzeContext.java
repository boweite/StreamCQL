...
/**
 * show application 命令解析内容
 * 
 */
public class ShowApplicationAnalyzeContext extends AnalyzeContext
{
    private ShowApplicationsContext context;
    ...
    {
        context = (ShowApplicationsContext)parseContext;
    }
    ...
    {
        return CQLUtils.cqlStringLiteralTrim(context.getApplicationName());
    }
}
