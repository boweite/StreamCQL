 ...
 * 
 */
public class LimitClauseAnalyzer extends BaseAnalyzer
{
    private LimitClauseAnalzyeContext submitContext;
     ...
     */
    public LimitClauseAnalyzer(ParseContext parseContext)
    ...
    {
        submitContext = new LimitClauseAnalzyeContext();
    }
