...
public class SplitterOperator extends Operator
{
    ...
    private List<SplitterSubContext> subSplitters = Lists.newArrayList();
     ...
     */
    public SplitterOperator(String id, int parallelNumber)
    {
    ...
    public void setSubSplitters(List<SplitterSubContext> subSplitters)
    {
