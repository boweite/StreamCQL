 ...
 *
 */
public class StormApplicationResults implements ApplicationResults
{
    private static final Logger LOG = LoggerFactory.getLogger(StormApplicationResults.class);
