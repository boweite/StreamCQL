...
public class KerberosSecurity implements StreamingSecurity
{
     ...
     *
     * @param config 配置属性
     * @throws StreamingException 构建jaas文件失败
     */
     ...
     * 删除jaas文件
     *
     * @throws StreamingException 文件删除失败
     */
     ...
     * 写入jaas文件
     *
     * @throws StreamingException 写文件异常
     */
     ...
     *
     * @param config 配置属性
     * @throws StreamingException 配置属性解析异常
     */
    private void readStormPrincipal(StreamingConfig config)
        throws StreamingException
    {
        ...
        {
            StreamingException exception =
                new StreamingException(ErrorCode.CONFIG_NOT_FOUND, StreamingConfig.STREAMING_SECURITY_STORM_PRINCIPAL);
     ...
     *
     * @param config 配置属性
     * @throws StreamingException 配置属性读取异常
     */
