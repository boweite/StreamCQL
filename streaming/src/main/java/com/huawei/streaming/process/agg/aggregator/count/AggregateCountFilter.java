 ...
 * 
 */
public class AggregateCountFilter extends AggregateCount
{
    
    /**
     * ID
     */
    private static final long serialVersionUID = -2676016304604665308L;
    
    /**
     * <默认构造函数>
     *@param type 类型
     */
    public AggregateCountFilter(Class< ? > type)
    {
        super(type);
    }
    ...
    {
        return new AggregateCountFilter(getValueType());
    }
