...
/**
 * 
 * <LengthBatchWindowTest>
 * <功能详细描述>
 * 
 */
public class LengthBatchWindowTest
{
    private LengthBatchWindow myView = null;
    ...
    public void setUp()
        throws Exception
    {
        myView = new LengthBatchWindow(SupportConst.I_FIVE);
    ...
    public void testUpdate()
    {
        ...
        SupportViewDataCheck.checkNewData(childView, new IEvent[] {event6, event7, event8, event9, event10});
    }
     ...
     */
    @Test
    public void testLengthBatchWindow()
    {
        try
        {
            myView = new LengthBatchWindow(0);
            fail();
        }
