...
public class AggregateMinTest
{
    ...
    public void testAggregateMax()
    {
        ...
        try
        {
            agg = new AggregateMin(String.class);
            fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    {
        agg = new AggregateMin(Long.class);
        
        assertEquals(Long.class, agg.cloneAggregate().getValueType());
        assertEquals(true, agg.cloneAggregate() instanceof AggregateMin);
    }
    ...
    {
        //Integer
        agg = new AggregateMin(Integer.class);
        ...
        //Double
        agg = new AggregateMin(Double.class);
        ...
        //Float
        agg = new AggregateMin(Float.class);
