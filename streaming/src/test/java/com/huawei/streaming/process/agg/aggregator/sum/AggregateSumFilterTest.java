...
/**
 * <AggregateSumFilterTest>
 * <功能详细描述>
 * 
 */
public class AggregateSumFilterTest
{
    ...
    private AggregateSumFilter agg = null;
    ...
    {
        agg = new AggregateSumFilter(Double.class);
        
        assertEquals(Double.class, agg.cloneAggregate().getValueType());
        assertEquals(true, agg.cloneAggregate() instanceof AggregateSumFilter);
    }
    
    /**
     * Test AggregateSumFilter(java.lang.Class).
     */
    @Test
    public void testAggregateSumFilter()
    {
        try
        {
            agg = new AggregateSumFilter(null);
            fail();
        }
        ...
        try
        {
            agg = new AggregateSumFilter(String.class);
            fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    /**
     * <testAggregateSumFilterFunction (enter, leave, getValue)>
     * <功能详细描述>
     */
    @Test
    public void testAggregateSumFilterFunction()
    {
        //Double
        agg = new AggregateSumFilter(Double.class);
        ...
        agg.enter(D_TWO, false);
        assertEquals(D_ONE, agg.getValue());
        
        agg.leave(D_TWO, false);
        assertEquals(D_ONE, agg.getValue());
        ...
        //Float
        agg = new AggregateSumFilter(Float.class);
        ...
        agg.enter(F_TWO, false);
        assertEquals(F_ONE, agg.getValue());
        
        agg.leave(F_TWO, false);
        assertEquals(F_ONE, agg.getValue());
        ...
        //Integer
        agg = new AggregateSumFilter(Integer.class);
        ...
        agg.enter(I_TWO, false);
        assertEquals(I_ONE, agg.getValue());
        
        agg.leave(I_TWO, false);
        assertEquals(I_ONE, agg.getValue());
        ...
        //Long
        agg = new AggregateSumFilter(Long.class);
        ...
        agg.enter(L_TWO, false);
        assertEquals(L_ONE, agg.getValue());
        
        agg.leave(L_TWO, false);
        assertEquals(L_ONE, agg.getValue());
