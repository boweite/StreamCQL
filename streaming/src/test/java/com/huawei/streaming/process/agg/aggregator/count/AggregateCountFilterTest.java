...
/**
 * <AggregateCountFilterTest>
 * <功能详细描述>
 * 
 */
public class AggregateCountFilterTest
{
    private AggregateCountFilter agg = null;
    ...
    {
        agg = new AggregateCountFilter(Long.class);
        
        assertEquals(Long.class, agg.cloneAggregate().getValueType());
        assertEquals(true, agg.cloneAggregate() instanceof AggregateCountFilter);
    }
     ...
     */
    @Test
    public void testAggregateCountFilter()
    {
        agg = new AggregateCountFilter(Long.class);
