...
/**
 * <AggregateMinFilterTest>
 * <功能详细描述>
 * 
 */
public class AggregateMinFilterTest
{
    private AggregateMinFilter agg = null;
    ...
    public void testAggregateAvgFilter()
    {
        try
        {
            agg = new AggregateMinFilter(null);
            fail();
        }
        ...
        try
        {
            agg = new AggregateMinFilter(String.class);
            fail();
        }
        catch (IllegalArgumentException e)
        {
    ...
    {
        agg = new AggregateMinFilter(Long.class);
        
        assertEquals(Long.class, agg.cloneAggregate().getValueType());
        assertEquals(true, agg.cloneAggregate() instanceof AggregateMinFilter);
    }
    ...
    {
        //Integer
        agg = new AggregateMinFilter(Integer.class);
        ...
        agg.enter(SupportConst.I_TWO, false);
        assertEquals(SupportConst.I_TEN, agg.getValue());
        
        agg.leave(SupportConst.I_TWO, false);
        assertEquals(SupportConst.I_TEN, agg.getValue());
        ...
        agg.enter(SupportConst.L_TWO, false);
        assertEquals(SupportConst.L_TEN, agg.getValue());
        
        agg.leave(SupportConst.L_TWO, false);
        assertEquals(SupportConst.L_TEN, agg.getValue());
        ...
        //Double
        agg = new AggregateMinFilter(Double.class);
        ...
        agg.enter(SupportConst.D_TWO, false);
        assertEquals(SupportConst.D_TEN, agg.getValue());
        
        agg.leave(SupportConst.D_TWO, false);
        assertEquals(SupportConst.D_TEN, agg.getValue());
        ...
        //Float
        agg = new AggregateMinFilter(Float.class);
        ...
        agg.enter(SupportConst.F_TWO, false);
        assertEquals(SupportConst.F_TEN, agg.getValue());
        
        agg.leave(SupportConst.F_TWO, false);
        assertEquals(SupportConst.F_TEN, agg.getValue());
